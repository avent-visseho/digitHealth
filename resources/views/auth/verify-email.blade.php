                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        ...
                                        <div class="p-2 mt-4">
                                            ...
                                            <form method="POST" action="{{ route('verification.send') }}">
                                                @csrf
                                                <div class="mt-4">
                                                    <button class="btn btn-primary w-10" type="submit">Resend Verification
                                                        <Email></Email>
                                                    </button>
                                                </div>
                                            </form>
                                    ...
                                    <div class="mt-5 text-center">
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <p class="text-muted mb-0">Didn't receive an email ? <button
                                                    class="text-primary fw-semibold">Logout</button> </p>
                                        </form>
                                    </div>
                                </div>
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">©
                                        ...
                                        </script> DigitHealth . Crafted with <i
